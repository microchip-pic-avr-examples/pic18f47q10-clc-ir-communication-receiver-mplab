...
#### To see the Gray Code Decoder demo operation video, click on the below image.
...
* Switches S1 and S2 are used to send IR commands to the IR receiver.
...
* Pressing switch S2 will send the IR command equal to the switch press count plus 0x80 i.e. from 0x81 to 0x88. After 8th count the command 0x81 to 0x88 are repeated. Indication LED D5 will turn on for 200 mS after command is sent .
...
* Press switch S2 to send commands #83 to the receiver as shown in figure 12.

<p align="center">
  <img width=auto height=auto src="images/blockdiagram.png">
  <br>Figure 12: Press switch S2 to send commands #83 <br>
</p> 

* Receiver after receiving command #83

<p align="center">
  <img width=auto height=auto src="images/blockdiagram.png">
  <br>Figure 13: Receiver after receiving command #83<br>
</p> 
...
9.Command #81: make brightness of LED D2 25%.
10.Command #82: make brightness of LED D2 50%
11.Command #83: make brightness of LED D2 75%.
12.Command #84: make brightness of LED D2 100%
13.Command #85: make brightness of LED D2 75%.
14.Command #86: make brightness of LED D2 50%
15.Command #87: make brightness of LED D2 25%.
16.Command #88: make brightness of LED D2 0%.  
